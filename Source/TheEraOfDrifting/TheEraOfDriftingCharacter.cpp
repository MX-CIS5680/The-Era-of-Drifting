...
ATheEraOfDriftingCharacter::ATheEraOfDriftingCharacter()
{
...
void ATheEraOfDriftingCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void ATheEraOfDriftingCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ATheEraOfDriftingCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ATheEraOfDriftingCharacter::Look);
	}
	else
	{
...
void ATheEraOfDriftingCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ATheEraOfDriftingCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
